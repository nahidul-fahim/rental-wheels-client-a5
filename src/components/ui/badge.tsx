  ...
  "inline-flex items-center rounded-md border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-green-100 text-green-700 shadow hover:bg-green-500/20 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/80",
        warning:
          "border-transparent bg-yellow-100 text-yellow-700 shadow hover:bg-yellow-300/20 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/80",
        destructive:
